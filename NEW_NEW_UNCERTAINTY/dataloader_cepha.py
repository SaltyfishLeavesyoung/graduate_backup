...
ISBI_PATH = "../IEEE ISBI 2015 Challenge"
ISBI_LANDMARK = 19
SIZE = [800, 640]
R_RATIO = 0.05
...
class Cephalometric(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return item['image'], landmarks, mask, guassian_mask, offset_y, offset_x, landmark_list

    def __len__(self):
        return len(self.list)

if __name__ == '__main__':
    test = Cephalometric('../IEEE ISBI 2015 Challenge', 'Test1')
    for i in range(10):
