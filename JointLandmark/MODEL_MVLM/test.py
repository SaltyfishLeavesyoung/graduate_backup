...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume_p2v2c', default="/home/yzy/Desktop/JointLandmark/MODEL_MVLM/checkpoint/checkpoint_best_499.pth.tar", type=str,
