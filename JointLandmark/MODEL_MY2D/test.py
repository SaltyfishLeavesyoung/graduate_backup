...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume_p2v2c', default='/home/yzy/Desktop/JointLandmark/MODEL_MY2D/record/best_3.tar', type=str,
    ...
    input = torch.randn(2, 3, 800, 640).cuda()
    macs, params = profile(net, inputs=(input, ), verbose=True)
    print('params: ', params)
