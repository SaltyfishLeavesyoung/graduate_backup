...
def getAdjMatrix(k=5, path = '/home/yeziyang/Desktop/JointLandmark/data'):
    
    landmark_list = list()

    with open(os.path.join('/home/yeziyang/Desktop/JointLandmark/train.txt')) as f:
    ...
    with open(os.path.join('/home/yeziyang/Desktop/JointLandmark/test.txt')) as f:
        line = f.readline().split()[0]
        while line:
            temp_list = list()
            idx = str(int(line))
