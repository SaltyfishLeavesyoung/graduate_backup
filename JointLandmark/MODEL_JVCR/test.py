...
def test(logger, dataloader_1, net):
    ...
    for inputs, target, meta in tqdm(dataloader_1):
        ...
        with torch.no_grad():
            pred_vox, _, pred_coord = net.forward(input_var)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume_p2v2c', default="/home/yzy/Desktop/JointLandmark/MODEL_JVCR/checkpoint/checkpoint_p2v2c_500.pth.tar", type=str,
    ...
    # Load model
    net = pvcNet(args.stacks, args.blocks, args.depth_res, nParts=6,
