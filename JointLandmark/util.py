...
def getAdjMatrix(k=5, path = '/home/yzy/Desktop/JointLandmark/data'):
    
    landmark_list = list()

    with open(os.path.join('/home/yzy/Desktop/JointLandmark/train.txt')) as f:
        line = f.readline().split()[0]
        while line:
            temp_list = list()
            idx = str(int(line))
            with open(os.path.join(path, idx, 'L.txt')) as f1:
                for i in range(6):
            ...
            temp_list = list()
            with open(os.path.join(path, idx, 'R.txt')) as f1:
                for i in range(6):
                    landmark = f1.readline().split()
                    landmark = [int(i) for i in landmark]
                    temp_list.append(landmark)
    ...
    with open(os.path.join('/home/yzy/Desktop/JointLandmark/test.txt')) as f:
        line = f.readline().split()[0]
        while line:
            temp_list = list()
            idx = str(int(line))
...
if __name__ == "__main__":
    imgl = Image.open('/home/yzy/Desktop/JointLandmark/data/2/sampleL0.jpg').convert('RGB')
    imgr = Image.open('/home/yzy/Desktop/JointLandmark/data/2/sampleR0.jpg').convert('RGB')
    keypointl = list()
    keypointr = list()
    with open(os.path.join('/home/yzy/Desktop/JointLandmark/data/2/L.txt')) as f1:
        for i in range(6):
            landmark = f1.readline().split()
            landmark = [int(i) for i in landmark]
            keypointl.append(landmark)
    with open(os.path.join('/home/yzy/Desktop/JointLandmark/data/2/R.txt')) as f1:
        for i in range(6):
            landmark = f1.readline().split()
            landmark = [int(i) for i in landmark]
